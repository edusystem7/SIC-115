    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cuenta_proceso', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='catalogo.CuentaHija')),
            ],
        ),
        migrations.CreateModel(
            name='Programacion',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('proceso', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='contabilidad_costos.Proceso')),
                ('programacion', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='contabilidad_costos.Programacion')),
            ],
        ),
        migrations.AddField(
