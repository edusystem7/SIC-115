...
<%end if%>
					...
					id="ManualUsuario_salvacolor">
					<param name="movie" value="../../flash/ManualUsuario_salvacolor.swf">
					...
					name="ManualUsuario_salvacolor"
					width="400" height="70"
					src="../../flash/ManualUsuario_salvacolor.swf"
					bgcolor="#F4F4F4"
					quality="high"
					swliveconnect="true"
			...
			<div id="element-box">
				<div class="m" align="center">
					<object id="resourceobject" data="manual.pdf" type="application/pdf" width="800" height="600">
						<param name="src" value="manual.pdf" />
					</object>
					<br><br>
					<table align="center">
					<tr>
					<td><h3><A HREF="menu_contabilidad_costos.asp">anterior</A></h3></td>
					<td>&nbsp;</td>
					<td><h3><A HREF="menu_ayuda.asp">siguiente</A></h3></td>
					</tr>
					</table>
					<div class="clr"></div>
				</div>
